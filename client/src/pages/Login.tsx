...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:5000/auth/login", form, { withCredentials: true });
    ...
    <div className="flex items-center justify-center h-screen bg-gradient-to-br from-gray-900 to-black text-white px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-700">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm mt-1 text-gray-400">Welcome back! Shorten your journey.</p>
        </div>
        ...
        <div className="flex justify-center items-center mt-6">
          <button
            ...
            type="button"
            className="flex items-center gap-2 px-4 py-2 border border-gray-500 rounded-md hover:bg-gray-700 transition-colors"
          >
